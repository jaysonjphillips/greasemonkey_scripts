...
// @version       1.0.4 -  Updated for latest changes per main stream changes from M. Schultz. See notes below.
...
function removeRedundant(){
  ...
  textNodes = document.evaluate("//span[@class='UIStory_Message']//text() | //div[@class='comment_actual_text']//text() | //div[@class='info_section']//text() | //h3[@class='GenericStory_Message']//text() | //div[@class='walltext']//text()", document, null, XPathResult.UNORDERED_NODE_SNAPSHOT_TYPE,null);
